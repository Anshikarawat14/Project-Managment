...
export default function NewProject({onAdd,onCancel})
{
    ...
    return (
        ...
        <Modal ref={modal} buttonCaption="Okay">
            ...
            <p className='text-stone-600 mb-4'>Please make sure to provide the valid input</p>
        </Modal>
        ...
        //my-4 means adding margin vertically with 4 rem & mt-16 means margin from top 16 rem
